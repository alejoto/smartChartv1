...
--
-- Host: localhost
-- Generation Time: May 12, 2014 at 03:53 AM
...
--
-- Database: `localth8_S-ecam`
--
DROP DATABASE `localth8_S-ecam`;
CREATE DATABASE `localth8_S-ecam` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `localth8_S-ecam`;
...
(1, 'datereading', 'Date', 'Date', 1, 'register', '', '', '', '', '2014-02-15 05:00:00', '2014-02-15 05:00:00'),
(2, 'timereading', 'Time', 'Time', 1, 'register', '', '', '', '', '2014-02-15 05:00:00', '2014-02-15 05:00:00'),
...
CREATE TABLE IF NOT EXISTS `buildingregisters` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=27935 ;
